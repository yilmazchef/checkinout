...
public class DesktopLayout extends AppLayout {
	...
	public DesktopLayout( @Autowired AuthenticationService authService, @Autowired SessionService sessionService ) {
		...
		final var title = new H1( "Intec Brussel Aanmeldingssysteem" );
		title.getStyle()
