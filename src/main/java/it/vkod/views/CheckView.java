            ...
            courseSelect.addValueChangeListener(onSelection -> {
                ...
                if (matchesWithTrainersCourse) {
                    ...
                    scanner.addValueChangeListener(qr -> {
                        ...
                        if (oAttendee.isPresent() && typeSelect.getValue().equalsIgnoreCase(CHECK_IN)) {
                        ...
                        } else if (oAttendee.isPresent() && typeSelect.getValue().equalsIgnoreCase(CHECK_OUT)) {
                    ...
                    final var trainingChangedMessage = Notification.show("Switched to " + onSelection.getValue());
