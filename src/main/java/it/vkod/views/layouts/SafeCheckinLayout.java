...
public class SafeCheckinLayout extends VerticalLayout {
    ...
    public SafeCheckinLayout(final AuthenticationService authService, final UserService userService, final CheckService checkService) {
