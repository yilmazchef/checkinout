...
public class PDFExporter {
    ...
    public void export(HttpServletResponse response, List<Check> checks) throws IOException {
        ...
        final var document = new Document(A4);
    ...
    private void writeTableHeader(PdfPTable table) {
        ...
        cell.setPhrase(new Phrase("Tijd", font));
        table.addCell(cell);
    ...
    private void writeTableData(PdfPTable table, List<Check> checks) {
        ...
        for (Check check : checks) {
            ...
            table.addCell(new Phrase(check.getOnDate().toString(), cFont));
            table.addCell(new Phrase(check.getAtTime().toString(), cFont));
            table.addCell(new Phrase(check.getEvent().toString(), cFont));
        }
    }
