...
public class CSVExporter {
    ...
    public void export(HttpServletResponse response, List<CheckDTO> data) throws IOException, CsvRequiredFieldEmptyException, CsvDataTypeMismatchException {

        //create a csv writer
        final var writer = new StatefulBeanToCsvBuilder<CheckDTO>(response.getWriter())
